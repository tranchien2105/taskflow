...
describe('TasksService', () => {
  ...
  it('should create task successfully', async () => {
    ...
    // Creator là member
    projectMembersService.isMember
  ...
  it(
    'should reject when creator is not a project member',
    async () => {
      // Arrange
      const dto = {
        projectId: 'project-1',
  ...
  it(
    'should reject when assignee is not a project member',
    async () => {
      // Arrange
      const dto = {
        projectId: 'project-1',
  ...
  it(
    'should allow manager to change assignee',
    async () => {
      // Arrange
      const task = {
        id: 'task-1',
